...
public interface DomainmodelPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.example.domainmodel.domainmodel.Type#getSd <em>Sd</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Sd</em>'.
   * @see org.example.domainmodel.domainmodel.Type#getSd()
   * @see #getType()
   * @generated
   */
  EReference getType_Sd();
  ...
  /**
   * Returns the meta object for the attribute '{@link org.example.domainmodel.domainmodel.Entity#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see org.example.domainmodel.domainmodel.Entity#getName()
   * @see #getEntity()
   * @generated
   */
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EReference TYPE__SD = eINSTANCE.getType_Sd();
